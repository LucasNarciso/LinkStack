...
<body id="body" align="center">
    ...
    <div id="janela" style="box-shadow: 3px 3px 10px black;">
        ...
        <div style="width: 80%; padding: 0.5em;">

            <form id="formGeral" action="LS-Painel.php" method="POST">

                <!--////////////////////    ÁREA DE FOTO E NOME -->

                <div class="divborder" style="display: flex; align-items: center; justify-content: center;">
                ...
                <div align="center" class="divCards">
                    ...
                    <div id="divInternaCards" class="divborder divInternaCards">
                            ...
                            for ($i=0; $i < $DadosUser[0]; $i++) { 
                                echo "<div id='card".($i+1)."' class='linkCardED'>
                                    ...
                                    <div style='width: 20em;'>
                                        <div>
                                            <img id='bLixeira".($i+1)."' class='hover' onclick='apagarCard(card".($i+1).")' src='imagens/Icone_Lixeira.svg' alt='Icone de Deletar o Card' width='20em'>
                                        </div>
                                        <button class='buttonLinks' > < </button>
                                        <input id='inputPos".($i+1)."' style='border-radius: 2em; text-align: center; width: 2em; margin: 0.3em;' readonly type='text' value='" . $i+1 ."'>
                                        <button class='buttonLinks' > > </button>
                                    </div>
                                </div>";
                            }
                ...
                <div style="width: 100%; padding: 0.5em;">
                    <div align="center" class="divborder" style="height: 100%; background-color: white;">
